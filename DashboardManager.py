...
class DashboardManager:
    ...
    def setup_footer(self):
        ...
        footer = dbc.NavbarSimple(
            brand="This dashboard is created by: Timothy Adegbola",
            brand_href="#",
            color="secondary",
            dark=True,
            children=[
            ...
            dbc.NavItem(
                dbc.NavLink(
                    ...
                    href="https://github.com/timadeg",  # Replace with your GitHub link
                    target="_blank"
                )
            ),
            ...
            dbc.NavItem(
                dbc.NavLink(
                    html.I("Website",className="fab", style={"font-size": "1em", "font-weight": "bold"}),  # Kaggle icon using "K"
                    href="https://www.vokallond.com",  # Replace with your Kaggle link
                    target="_blank"
                )
            ),
            ...
            dbc.NavItem(
                dbc.NavLink(
                    ...
                    href="https://www.linkedin.com/in/timothy-adegbola/",  # Replace with your LinkedIn link
                    target="_blank"
                )
            )
            ],
